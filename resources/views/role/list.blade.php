...
@section('content_header_subtitle', __('custom.roles'))
                ...
                <tbody>
                    @foreach ($roles as $role)
                        <tr>
                            ...
                            {{-- <td>
                                <label class="switch">
                                    <input type="checkbox" data-id='{{$role->id}}' oninput="update_status(this)" @checked($category->status)>
                                    <span class="slider round"></span>
                                  </label>
                            </td> --}}
                            <td>
                                {{-- <button data-delete-url='{{route('category.delete',['id'=>$role->id])}}'  class="btn btn-primary delete-button" ><i class="fas fa-trash"></i></button> --}}
