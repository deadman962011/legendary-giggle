			...
			<div class="modal-header pb-0 bg-light">
				<div class="uppy-modal-nav">
					<ul class="nav nav-tabs border-0">
						<li class="nav-item">
							<a class="nav-link active font-weight-medium text-dark" data-toggle="tab" href="#aiz-select-file">{{ __('Select File') }}</a>
						</li>
						<li class="nav-item">
							<a class="nav-link font-weight-medium text-dark" data-toggle="tab" href="#aiz-upload-new">{{ __('Upload New') }}</a>
						</li>
					</ul>
				</div>
                <span data-dismiss="modal" aria-label="Close" class="span-close-img">&times;</span>
			</div>
							...
							<div class="row align-items-center gutters-5 gutters-md-10 position-relative">
								...
								<div class="col-md-4 col-xl-3 ml-auto mr-0 col-2 position-static">
									<div class="aiz-uploader-search text-right">
										<input type="text" class="form-control form-control-xs" name="aiz-uploader-search" placeholder="{{ __('Search your files') }}">
						...
						<div class="aiz-uploader-all clearfix c-scrollbar-light">
							<div class="align-items-center d-flex h-100 justify-content-center w-100">
								<div class="text-center">
									<h3>{{ __('custom.no_files_found') }}</h3>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="modal-footer justify-content-between bg-light">
				<div class="flex-grow-1 overflow-hidden d-flex">
					<div class="">
						...
						<button type="button" class="btn-link btn btn-sm p-0 aiz-uploader-selected-clear">{{ __('Clear') }}</button>
					</div>
					<div class="mb-0 ml-3">
