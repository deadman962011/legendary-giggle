...
<body style="font-family: Arial, sans-serif; margin: 0; padding: 0; background-color: #f4f4f4;">
    <div style="max-width: 600px; margin: 0 auto; padding: 20px; background-color: #ffffff; border-radius: 5px;">
        <div style="text-align: center;">
            <img src="{{url('/images/logo.png')}}" alt="Your Website Logo" style="max-width: 200px; height: auto;">
        </div>
        <div style="padding: 40px; text-align: center; background-color: #ffffff;">
            ...
            <a href="https://auth.mybill1.com?action={{$action}}&token={{$token}}" style="display: inline-block; color: #ffffff; background-color: #007bff; padding: 12px 24px; margin-top: 20px; text-decoration: none; border-radius: 5px; font-size: 16px;">Log In</a>
